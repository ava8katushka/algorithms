...
# What time and space complexity is, exactly? 
...
### O(1): Logarithmic time complexity

Logarithm grows very slow. Logarithm of 1000 ~ log 1024 = 10
If we square the input, log 1000^2 = 2 log 1000 ~ 20
It works with any power. E.g. log 1000^5 = 5 log 1000 ~ 50
Logarithmic algorithms in practice are very fast. 

Example:
Finding number in a sorted array 
...
**Finding 87 in sorted array of 100 natural numbers would go:**
1. Search from 1 to 100 number 87. Middle is 50. 50 is smaller than 87.
2. Search from 51 to 100 number 87. Middle is 75. 75 is smaller than 87.
3. Search from 76 to 100 number 87. Middle is 88. 88 is bigger than 87.
4. Search from 76 to 88 number 87. Middle is 82. 82 is smaller than 87.
5. Search from 83 to 88 number 87. Middle is 85. 85 is smaller than 87.
6. Search from 86 to 88 number 87. Middle is 87. We found it! 

In total of 6 steps we were able to find a number in array of 100 numbers! Impressive!
If algorithm is logarithmic it guarantees you, that you will do only O(log n) steps.
