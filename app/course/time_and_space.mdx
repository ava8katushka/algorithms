...
import YoutubeClassic from "../components/YoutubeClassic";
import Code from "../components/Code";


<YoutubeClassic code="8ZjgN0POkEo?si=pRSJIv_XUvBRSLiB"/>
...
<Code>
{
`def multiply(arr): # length of arr is "n"
    res = 1
    for a in arr:
        res *= a
    return res
